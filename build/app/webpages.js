...
goog.provide('app.AppLogger.view');

goog.require('soy');
goog.require('soydata');


app.AppLogger.view.getPrimary = function(opt_data, opt_ignored) {
...
goog.provide('app.Login.view');

goog.require('soy');
goog.require('soydata');


app.Login.view.getPrimary = function(opt_data, opt_ignored) {
...
goog.provide('app.MainLauncher.view');

goog.require('soy');
goog.require('soydata');


app.MainLauncher.view.getPrimary = function(opt_data, opt_ignored) {
